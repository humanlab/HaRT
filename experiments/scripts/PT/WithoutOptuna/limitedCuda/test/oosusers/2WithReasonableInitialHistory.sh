...
python -O hulm_ar/HULM_AR/run_clm.py \
    ...
    --instantiate_hart \
    --add_history \
    --initial_history /users/nisoni/hulm_ar/HULM_AR/initial_history/initialized_history_tensor_torch14.pt \
    --do_train \
    --do_eval \
    --hostname localhost \
    --db HuLM \
    ...
    --output_dir hulm_ar/HULM_AR/experiments/outputs/WithoutOptuna/test/oosusers/2WithReasonableInitialHistory \
    --num_train_epochs 1 \
