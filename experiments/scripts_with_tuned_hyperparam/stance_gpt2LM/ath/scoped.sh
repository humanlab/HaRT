...
python -O HULM_AR/run_ft_gpt2.py \
    --learning_rate 0.00011250270401343517 \
    ...
    --block_size 50 \
    --output_dir /home/nisoni/new_models/FT/gpt2LMFT_ctlb_fb/stance/ath \
    --hostname 130.245.162.235 \
    --db stance_hulm \
    --train_table stance_ath_train \
    --dev_table stance_ath_dev \
    --test_table stance_ath_test \
