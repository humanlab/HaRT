...
python -O HULM_AR/run_ft_gpt2.py \
    --learning_rate 0.00015499180703867855 \
    ...
    --block_size 50 \
    --output_dir /home/nisoni/new_models/FT/gpt2LMFT_ctlb_fb/stance/clim \
    --hostname 130.245.162.235 \
    --db stance_hulm \
    --train_table stance_clim_train \
    --dev_table stance_clim_dev \
    --test_table stance_clim_test \
